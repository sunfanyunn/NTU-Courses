...
#ifndef lint
static char IntervalHeap_RcsId[] = "@(#)$Header: /home/srilm/devel/dstruct/src/RCS/IntervalHeap.cc,v 1.6 2008/09/27 22:11:54 stolcke Exp $";
#endif
...
IntervalHeap<T, Less, Greater, Equal>::IntervalHeap(int IntervalHeapSize)
  :heap(0, IntervalHeapSize / 2 + IntervalHeapSize % 2), CurrentSize(0)
{
}
